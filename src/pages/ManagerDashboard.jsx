...
export default function ManagerDashboard() {
 ...
 className="p-2.5 glass-card border border-[var(--border-color)] rounded-full hover:glass-card transition-all hover:shadow-md disabled:opacity-40 disabled:cursor-not-allowed group flex-shrink-0"
 title="Go Back (Esc)"
 >
 ...
 className="btn-premium bg-[#111111] [#F8F5F0] text-[#F8F5F0] [#111111] rounded-full py-2.5 px-6 text-xs font-bold shadow-md flex items-center gap-2"
 >
 <Plus size={16} />
 Log Grocery Stock
 </button>
 ...
 className={`pb-3 font-extrabold text-xs uppercase tracking-wider border-b-2 transition-all shrink-0 ${activeTab === 'catalog' ? 'border-[var(--color-primary)] text-[var(--color-primary)]' : 'border-transparent text-slate-555 hover:text-gray-300'}`}
 >
 Master Menu Catalog ({menuItems.length})
 </button>
 <button
 onClick={() => handleTabChange('inventory')}
 className={`pb-3 font-extrabold text-xs uppercase tracking-wider border-b-2 transition-all shrink-0 ${activeTab === 'inventory' ? 'border-[var(--color-secondary)] text-rose-400' : 'border-transparent text-slate-555 hover:text-gray-300'}`}
 >
 Raw Ingredients Inventory ({groceryItems.length})
 </button>
 <button
 onClick={() => handleTabChange('specials')}
 className={`pb-3 font-extrabold text-xs uppercase tracking-wider border-b-2 transition-all shrink-0 ${activeTab === 'specials' ? 'border-pink-400 text-pink-400' : 'border-transparent text-slate-555 hover:text-gray-300'}`}
 >
 Restaurant Specials ({specials.length})
 </button>
 <button
 onClick={() => handleTabChange('analytics')}
 className={`pb-3 font-extrabold text-xs uppercase tracking-wider border-b-2 transition-all shrink-0 ${activeTab === 'analytics' ? 'border-cyan-555 text-cyan-550' : 'border-transparent text-slate-555 hover:text-gray-300'}`}
 >
 Menu & Sales Analytics
 </button>
 <button
 onClick={() => handleTabChange('alerts')}
 className={`pb-3 font-extrabold text-xs uppercase tracking-wider border-b-2 transition-all shrink-0 ${activeTab === 'alerts' ? 'border-red-500 text-red-500 animate-pulse' : 'border-transparent text-slate-555 hover:text-gray-300'}`}
 >
 Alert Center ({kitchenAlerts?.filter(a => a.status === 'active' || a.status === 'resolved').length || 0})
 </button>
 <button
 onClick={() => handleTabChange('parcel')}
 className={`pb-3 font-extrabold text-xs uppercase tracking-wider border-b-2 transition-all shrink-0 ${activeTab === 'parcel' ? 'border-[var(--color-primary)] text-[var(--color-primary)] shadow-glow-secondary' : 'border-transparent text-slate-555 hover:text-gray-300'}`}
 >
 ...
 className={`px-3 py-1 rounded-full text-[10px] font-extrabold transition-all border ${filterDietary === diet ? 'bg-[var(--color-primary)] text-[var(--color-text-main)] border-transparent shadow-sm' : 'bg-transparent border-[var(--border-color)] text-[var(--color-text-muted)] hover:text-[var(--color-text-muted)]'}`}
 >
 ...
 <div className="glass overflow-hidden border border-white/20 ">
 ...
 <tr key={item.id} className="hover:bg-[var(--bg-panel)]/50/10">
 ...
 className="px-1.5 py-0.5 glass-card hover:bg-gray-700 text-[8px] font-bold rounded"
 >
 +5
 </button>
 <button
 ...
 item.dietary === 'Veg' ? 'bg-rose-400/10 text-rose-400 border-[var(--color-secondary)]/20' :
 item.dietary === 'Non Veg' ? 'bg-red-500/10 text-red-400 border-red-500/20' :
 item.dietary === 'Vegan' ? 'bg-rose-400/10 text-emerald-450 border-[var(--color-secondary)]/20' :
 ...
 className="p-2 glass-card hover:bg-gray-700 rounded-xl text-[var(--color-text-muted)] "
 >
 <Edit3 size={14} />
 </button>
 <button
 onClick={() => deleteMenuItem(item.id)}
 className="p-2 bg-red-50 hover:bg-red-100/40 rounded-xl text-red-500"
 >
 <Trash2 size={14} />
 </button>
 </td>
 ...
 <div className="glass p-5 border border-white/20 flex flex-col gap-4">
 <div>
 ...
 <div 
 key={spec.id} 
 className="glass overflow-hidden border border-amber-550/20 bg-[#121212] rounded-3xl relative flex flex-col justify-between"
 >
 ...
 <span className="absolute top-3 right-3 bg-pink-400 text-[#111111] text-[9px] font-extrabold px-2.5 py-0.5 rounded-full uppercase tracking-wider">
 {spec.discount}
 </span>
 </div>
 ...
 className="w-full py-2 bg-[var(--bg-panel)]/60 hover:bg-red-500/10 text-[var(--color-text-muted)] hover:text-red-400 rounded-xl text-[10px] font-extrabold uppercase tracking-wider border border-white/5 hover:border-red-500/20 transition-all flex items-center justify-center gap-1.5"
 >
 <Trash2 size={12} />
 ...
 <p className="text-xs text-slate-450 max-w-2xl mt-1 leading-normal font-bold">
 ...
 <div className="glass p-6 border border-white/20 flex flex-col justify-between">
 ...
 <h3 className="text-3xl font-extrabold mt-3 text-rose-400">${parcelRevenue.toFixed(2)}</h3>
 </div>
 <div className="glass p-6 border border-white/20 flex flex-col justify-between">
 ...
 <div className="glass overflow-hidden border border-white/20 mt-6">
 ...
 <tr key={order.id || order.orderNo} className="hover:bg-[var(--bg-panel)]/50/10">
 ...
 (order.status === 'pending' || order.balanceParcelStatus === 'pending') ? 'glass-card text-[var(--color-text-muted)]' :
 ...
 (order.status === 'ready_for_pickup' || order.balanceParcelStatus === 'ready_for_pickup') ? 'bg-rose-400/20 text-rose-400' :
 order.status === 'delivered' ? 'bg-rose-400/10 text-rose-400' :
 ...
 <div>
 <h4 className="text-[10px] text-rose-400 font-extrabold uppercase tracking-wider flex items-center gap-1.5">
 🔥 Most Ordered Dishes
 </h4>
 ...
 <span className="bg-rose-400/10 text-rose-400 px-2.5 py-1 rounded-full text-[10px] font-bold border border-[var(--color-secondary)]/20">Adequate</span>
 )}
 </td>
 ...
 <span className="bg-rose-400/10 text-rose-400 px-2 py-0.5 rounded text-[9px] font-bold border border-[var(--color-secondary)]/20">Adequate</span>
 )}
 </div>
 ...
 <button
 onClick={() => deleteGroceryItem(item.id)}
 className="w-full py-2 bg-red-50 hover:bg-red-100/40 rounded-xl text-red-500 flex items-center justify-center gap-1.5 text-[10px] font-extrabold"
 >
 ...
 <div className="glass p-5 border border-white/20 ">
 ...
 <tr key={log.id} className="hover:bg-[var(--bg-panel)]/50/10">
 <td className="py-4 px-6">
 <span className={`px-2.5 py-1 rounded-full text-[9px] font-bold uppercase tracking-wider ${
 log.status === 'active' ? 'bg-red-500/10 text-red-500 border border-red-500/20 animate-pulse' :
 log.status === 'resolved' ? 'bg-rose-400/10 text-rose-400 border border-[var(--color-secondary)]/20' :
 'bg-gray-9000/10 text-[var(--color-text-muted)]'
 }`}>
 {log.status}
 </span>
 </td>
 ...
 className="p-2 bg-emerald-50 hover:bg-emerald-100/40 rounded-xl text-rose-400"
 ...
 <div className="glass w-full max-w-lg border border-white/20 relative flex flex-col shadow-2xl rounded-2xl max-h-[85vh] sm:max-h-[90vh]">
 ...
 className="px-3 py-1.5 glass-card hover:bg-gray-700 text-[10px] font-bold rounded-lg transition-all"
 >
 Replace
 </button>
 <button
 ...
 className="px-3 py-1.5 bg-red-50 hover:bg-red-100/40 text-[10px] font-bold text-red-500 rounded-lg transition-all"
 >
 Remove
 </button>
 </div>
 ...
 <div className="text-[10px] bg-gray-700 text-slate-650 px-2 py-0.5 rounded-full font-extrabold font-mono">
 {ing.qty} {ing.unit}
 </div>
 {ing.pantryLinkId && (
 <span className="text-[8px] bg-rose-400/15 text-rose-400 border border-emerald-555/20 px-1.5 py-0.5 rounded-full font-extrabold uppercase">
 Linked
 </span>
 )}
 </div>
 ...
 className={`p-1 rounded-lg hover:bg-gray-700 text-[var(--color-text-muted)] ${idx === 0 ? 'opacity-30 cursor-not-allowed' : ''}`}
 title="Move Up"
 >
 ▲
 </button>
 ...
 className={`p-1 rounded-lg hover:bg-gray-700 text-[var(--color-text-muted)] ${idx === menuIngredients.length - 1 ? 'opacity-30 cursor-not-allowed' : ''}`}
 title="Move Down"
 >
 ▼
 </button>
 ...
 className="p-1 rounded-lg hover:bg-red-50/20 text-red-500"
 ...
 <div className="text-[10px] text-slate-450 text-center py-2 bg-[var(--bg-panel)] rounded-xl border border-dashed border-[var(--border-color)] ">
 ...
 className="py-1.5 bg-[var(--color-primary)] hover:bg-[#E66A2B] text-[var(--color-text-main)] rounded-lg text-xs font-bold transition-all shadow-md flex items-center justify-center gap-1 h-9"
 >
 ...
 className="px-4 py-3 bg-red-50 hover:bg-red-100/40 text-red-500 rounded-xl font-bold text-xs flex items-center justify-center transition-all"
 title="Delete Dish"
 >
 <Trash2 size={16} />
 </button>
 ...
 type="button"
 onClick={() => { setShowAddMenuModal(false); setShowEditMenuModal(false); resetMenuForm(); }}
 className="flex-1 px-4 py-3 glass-card hover:bg-gray-700 text-gray-300 rounded-xl font-bold text-xs transition-all text-center"
 >
 Cancel
 </button>
 <button
 ...
 <div className="fixed inset-0 bg-[var(--bg-main)]/80 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-fade-in">
 <div className="glass w-full max-w-lg border border-white/20 relative flex flex-col shadow-2xl rounded-2xl max-h-[90vh]">
 ...
 : 'glass-card border-[var(--border-color)] text-gray-300 '
 }`}
 >
 <input 
 type="checkbox"
 ...
 <span className="text-[9px] text-slate-450 font-mono truncate block">{comboImage.substring(0, 40)}...</span>
 </div>
 </div>
 ...
 <div className="glass w-full max-w-md p-6 border border-white/20 relative flex flex-col gap-6 shadow-2xl">
 <button
